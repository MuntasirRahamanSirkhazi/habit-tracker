...
function SignupPage() {
    ...
    const [success, setSuccess] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$habittracker$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("");
    const handleSubmit = async (e)=>{
        var _signUpData_user;
        e.preventDefault();
        setError("");
        setSuccess("");
        // Sign up user with Supabase Auth
        const { data: signUpData, error: signUpError } = await __TURBOPACK__imported__module__$5b$project$5d2f$habittracker$2f$src$2f$lib$2f$supabaseClient$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].auth.signUp({
            email: form.email,
        ...
        const userId = signUpData === null || signUpData === void 0 ? void 0 : (_signUpData_user = signUpData.user) === null || _signUpData_user === void 0 ? void 0 : _signUpData_user.id;
        // Check if email already exists in your custom users table
        const { data: existingUser } = await __TURBOPACK__imported__module__$5b$project$5d2f$habittracker$2f$src$2f$lib$2f$supabaseClient$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("users").select("id").eq("email", form.email).single();
        if (!existingUser && userId) {
            // Insert into your custom users table (with name and auth user id)
            const { error: dbError } = await __TURBOPACK__imported__module__$5b$project$5d2f$habittracker$2f$src$2f$lib$2f$supabaseClient$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("users").insert([
                {
                    auth_user_id: userId,
                    name: form.name,
                    email: form.email
            ...
            children: [
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$habittracker$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("form", {
                    ...
                    children: [
                        ...
                        success && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$habittracker$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
...
_s(SignupPage, "egjKmBvAt5smRWpAh24TGDo96QI=");
_c = SignupPage;
var _c;
...
//# sourceMappingURL=habittracker_src_2489b1d5._.js.map