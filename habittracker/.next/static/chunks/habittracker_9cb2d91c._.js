...
function SignupPage() {
    ...
    const handleSignup = async (e)=>{
        e.preventDefault();
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$habittracker$2f$src$2f$lib$2f$supabaseClient$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].auth.signUp({
            email,
            password
        });
        if (error) {
...
_s(SignupPage, "Rc5QvcEU7xRaqjB2jUCdBs6Apgc=", false, function() {
    return [
...
//# sourceMappingURL=habittracker_9cb2d91c._.js.map